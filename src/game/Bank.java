 ...
 */
	public Bank() {
		...
		numberOfCapStand=4;
		String s = "<select name=\"myList\" id=\"ddlMyList\"><option value=\"http://www.google.com\">Google</option><option value=\"http://www.yahoo.com\">Yahoo</option></select><input type=\"button\" value=\"Go To Site!\" onclick=\"NavigateToSite()\" />";
		String s2 = "function NavigateToSite(){ var ddl = document.getElementById(\"ddlMyList\"); var selectedVal = ddl.options[ddl.selectedIndex].value; window.location = selectedVal;}";
